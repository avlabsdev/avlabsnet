...
import { faHouse } from '@awesome.me/kit-4a62263e08/icons/classic/solid';
    ...
    return (
        <header className={"flex flex-row items-center justify-between py-8 container mx-auto"}>
            ...
            <nav className={"flex flex-row items-center gap-16"}>
                <Link href="/" className={"flex flex-row items-center gap-2"}><FontAwesomeIcon icon={faHouse} className={"text-red-500"} />Home</Link>
